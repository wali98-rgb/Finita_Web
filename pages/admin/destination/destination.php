            ...
            <section class="content">
                ...
                <div class="container">
                    <div class="header-container">
                        <a href="create.php"><i class="bi bi-plus-circle"></i> Tambah Destinasi Kota</a>

                        <form method="get">
                            <input type="text" name="keyword" id="" placeholder="Cari Destinasi Kota">
                            <button type="submit">Cari</button>
                        </form>
                    </div>

                    <div class="body-container">
                        <!-- Logica of Destination Data -->
                        <?php
                        ...
                        ?>
                                ...
                                <div class="card-destination">
                                    ...
                                    <div class="card-body">
                                        <div class="head">
                                            ...
                                            <p>Destinasi : <?php echo $dat['time1'] . " - " . $dat['time2'] . " Jam"; ?></p>
                                        </div>

                                        <div class="body">
                                            <p class="desc"><?php echo substr($dat['desc_destination_city'], 0, 150) . "..."; ?></p>
                                            <h4>Mulai dari : <span>Rp.<?php echo $dat['base_price']; ?></span></h4>
                                        </div>
                                    </div>

                                    <div class="card-btn">
                                        <ul>
                                            <li><a class="btn-update" style="background-color: var(--primary); color: var(--color-font2)" href="update.php?id=<?php echo $dat['id_destination']; ?>"><i style="color: var(--color-font2);" class="bi bi-pencil"></i> Ubah</a></li>
                                            <li><a class="btn-delete" style="background-color: red; color: var(--color-font2)" href="delete.php?id=<?php echo $dat['id_destination']; ?>"><i style="color: var(--color-font2);" class="bi bi-trash"></i> Hapus</a></li>
                                            <li><a class="btn-view" style="background-color: blue; color: var(--color-font2)" href="view.php?id=<?php echo $dat['id_destination']; ?>"><i style="color: var(--color-font2);" class="bi bi-eye"></i> Lihat Detail</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- Card Content End -->
                            ...
                            ?>
                            <div class="card-destination">
                                <h1 style="display: flex; justify-content: center; width: 100%; font-style: italic; font-size: 1.3rem;">Destinasi Belum Ditambahkan.</h1>
                            </div>
                        <?php
                        }
                        ?>
