                            ...
                            <form action="update-act.php" method="post" enctype="multipart/form-data">
                                <div class="inp-col-1">
                                    <div class="form-inp">
                                        ...
                                        <input class="inp-file" type="file" name="img_destination" id="img_destination" value="<?php echo $dat['img_destination']; ?>" placeholder="Masukkan Foto Kota Destinasi" required>
                                        <input type="hidden" name="id_destination" id="id_destination" value="<?php echo $dat['id_destination'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-2">
                                    <div class="form-inp">
                                        ...
                                        <input type="text" name="destination_city" id="destination_city" value="<?php echo $dat['destination_city']; ?>" placeholder="Masukkan Kota Destinasi" required>
                                    </div>

                                    <div class="form-inp">
                                        <p><label for="early_city">Destinasi Kota Awal :</label></p>
                                        <input type="text" name="early_city" id="early_city" value="<?php echo $dat['early_city']; ?>" placeholder="Masukkan Destinasi Kota Awal" required>
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-3">
                                    <div class="form-inp">
                                        ...
                                        <textarea name="desc_destination_city" id="desc_destination_city" cols="30" rows="10" placeholder="Masukkan Deskripsi Kota Destinasi" required><?php echo $dat['desc_destination_city']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-4">
                                    <div class="form-inp">
                                        ...
                                        <input type="number" name="base_price" id="base_price" value="<?php echo $dat['base_price']; ?>" placeholder="Masukkan Harga Tiket Destinasi" required>
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-5">
                                    <div class="form-inp">
                                        ...
                                        <div class="time">
                                            <input type="number" name="time1" id="time1" value="<?php echo $dat['time1']; ?>" placeholder="Masukkan Harga Tiket Destinasi" required>
                                            <label for="time">s.d</label>
                                            <input type="number" name="time2" id="time2" value="<?php echo $dat['time2']; ?>" placeholder="Masukkan Harga Tiket Destinasi" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="inp-sub">
                                    <div class="note">
                                        <p>Form : Pengeditan Destinasi Kota</p>
                                    </div>
