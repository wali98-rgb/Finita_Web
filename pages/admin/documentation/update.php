                            ...
                            <form action="update-act.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="inp-col-1" style="display: none;" id="inputImg2">
                                    <div class="form-inp">
                                        ...
                                        <input class="inp-file" type="file" name="img_documentation2" id="img_documentation2" value="<?php echo $dat['img_documentation2']; ?>" placeholder="Masukkan Foto Dokumentasi 2">
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-1" style="display: none;" id="inputImg3">
                                    <div class="form-inp">
                                        ...
                                        <input class="inp-file" type="file" name="img_documentation3" id="img_documentation3" value="<?php echo $dat['img_documentation3']; ?>" placeholder="Masukkan Foto Dokumentasi 3">
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-1" style="display: none;" id="inputImg4">
                                    <div class="form-inp">
                                        ...
                                        <input class="inp-file" type="file" name="img_documentation4" id="img_documentation4" value="<?php echo $dat['img_documentation4']; ?>" placeholder="Masukkan Foto Dokumentasi 4">
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-1" style="display: none;" id="inputImg5">
                                    <div class="form-inp">
                                        ...
                                        <input class="inp-file" type="file" name="img_documentation5" id="img_documentation5" value="<?php echo $dat['img_documentation5']; ?>" placeholder="Masukkan Foto Dokumentasi 5">
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-1" style="display: none;" id="inputImg6">
                                    <div class="form-inp">
                                        ...
                                        <input class="inp-file" type="file" name="img_documentation6" id="img_documentation6" value="<?php echo $dat['img_documentation6']; ?>" placeholder="Masukkan Foto Dokumentasi 6">
                                    </div>
                                </div>
