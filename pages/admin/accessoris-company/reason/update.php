                ...
                <div class="container">
                    ...
                    <div class="body-container" id="content_container">
                        ...
                        <div class="cont-main">
                            ...
                            <?php
                            $id = $_GET['id'];
                            $data = mysqli_query($con, "SELECT * FROM reasons WHERE id_reason = '$id'");
                                ...
                                <form action="update-act.php" method="post">
                                    <div class="inp-col-1">
                                        <div class="form-inp">
                                            ...
                                            <input type="text" name="title_reason1" id="title_reason1" value="<?php echo $dat['title_reason1']; ?>" placeholder="Poin Alasan Pertama" required>
                                            <input type="hidden" name="id_reason" id="id_reason" value="<?php echo $dat['id_reason']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-2">
                                        <div class="form-inp">
                                            ...
                                            <textarea name="reason1" id="reason1" cols="30" rows="10" placeholder="Alasan Pertama" required><?php echo $dat['reason1']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-1">
                                        <div class="form-inp">
                                            ...
                                            <input type="text" name="title_reason2" id="title_reason2" value="<?php echo $dat['title_reason2']; ?>" placeholder="Poin Alasan Kedua" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-2">
                                        <div class="form-inp">
                                            ...
                                            <textarea name="reason2" id="reason2" cols="30" rows="10" placeholder="Alasan Kedua" required><?php echo $dat['title_reason2']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-1">
                                        <div class="form-inp">
                                            ...
                                            <input type="text" name="title_reason3" id="title_reason3" value="<?php echo $dat['title_reason3']; ?>" placeholder="Poin Alasan Ketiga" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-2">
                                        <div class="form-inp">
                                            ...
                                            <textarea name="reason3" id="reason3" cols="30" rows="10" placeholder="Alasan Ketiga" required><?php echo $dat['reason3']; ?></textarea>
                                        </div>
                                    </div>

                                    <div class="inp-sub">
                                        <div class="note">
                                            <p>Form : Pengeditan Alasan</p>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            $("#reason").click(function() {
                ...
                $.ajax({
                    url: "reason.php", // URL ke skrip PHP yang akan memproses permintaan
        ...
        $(document).ready(function() {
            $("#sponsor").click(function() {
                // Menggunakan AJAX untuk memuat konten baru dari server
                $.ajax({
                    url: "../sponsor/sponsor.php", // URL ke skrip PHP yang akan memproses permintaan
                    type: "GET", // Metode permintaan
                    success: function(response) {
                        // Menampilkan konten baru di dalam kontainer
                        $("#content_container").html(response);
        ...
        $(document).ready(function() {
            $("#question").click(function() {
                // Menggunakan AJAX untuk memuat konten baru dari server
                $.ajax({
                    url: "../question/question.php", // URL ke skrip PHP yang akan memproses permintaan
                    type: "GET", // Metode permintaan
                    success: function(response) {
                        // Menampilkan konten baru di dalam kontainer
                        $("#content_container").html(response);
        ...
        $(document).ready(function() {
            $("#goal").click(function() {
                // Menggunakan AJAX untuk memuat konten baru dari server
                $.ajax({
                    url: "../goal/goal.php", // URL ke skrip PHP yang akan memproses permintaan
                    type: "GET", // Metode permintaan
                    success: function(response) {
                        // Menampilkan konten baru di dalam kontainer
                        $("#content_container").html(response);
        ...
        $(document).ready(function() {
            $("#list").click(function() {
                // Menggunakan AJAX untuk memuat konten baru dari server
                $.ajax({
                    url: "data.php", // URL ke skrip PHP yang akan memproses permintaan
                    type: "GET", // Metode permintaan
                    success: function(response) {
                        // Menampilkan konten baru di dalam kontainer
                        $("#content_container").html(response);
