                ...
                <div class="container">
                    ...
                    <div class="body-container" id="content_container">
                        ...
                        <div class="cont-main">
                            ...
                            <?php
                            $id = $_GET['id'];
                            $data = mysqli_query($con, "SELECT * FROM companies WHERE id_company = '$id'");

                            while ($dat = mysqli_fetch_array($data)) {
                            ?>
                                <form action="../about/update-act.php" method="post" enctype="multipart/form-data">
                                    <div class="inp-col-1">
                                        <div class="form-inp">
                                            <p><label for="img_company">Foto Perusahaan :</label></p>
                                            <input type="file" name="img_company" id="img_company" value="<?php echo $dat['img_company']; ?>" placeholder="Foto Perusahaan" required>
                                            <input type="hidden" name="id_company" id="id_company" value="<?php echo $dat['id_company']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-2">
                                        <div class="form-inp">
                                            ...
                                            <input type="email" name="email_company" id="email_company" value="<?php echo $dat['email_company']; ?>" placeholder="Email Perusahaan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-2">
                                        <div class="form-inp">
                                            ...
                                            <input type="text" name="address_company" id="address_company" value="<?php echo $dat['address_company']; ?>" placeholder="Alamat Perusahaan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-2">
                                        <div class="form-inp">
                                            ...
                                            <input type="text" name="sosmed_company" id="sosmed_company" value="<?php echo $dat['sosmed_company']; ?>" placeholder="Sosial Media Perusahaan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inp-col-2">
                                        <div class="form-inp">
                                            ...
                                            <textarea name="desc_company" id="desc_company" cols="30" rows="10" placeholder="Deskripsi Perusahaan" required><?php echo $dat['desc_company']; ?></textarea>
                                        </div>
                                    </div>

                                    <div class="inp-sub">
                                        <div class="note">
                                            <p>Form : Pengeditan Deskripsi Perusahaan Finita Tour & Travel</p>
                                        </div>
