            ...
            <section class="content">
                ...
                <div class="container">
                    <div class="header-container">
                        ...
                        <form method="get">
                            <input type="text" name="keyword" id="" placeholder="Cari Artikel">
                    ...
                    <div class="body-container">
                        ...
                        ?>
                                ...
                                <div class="card-article">
                                    <div class="card-img">
                                        <img src="file_img/<?php echo $dat['img_article']; ?>" alt="<?php echo $dat['title_article']; ?>">
                                    </div>

                                    <div class="card-body">
                                        <h1><?php echo $dat['title_article']; ?></h1>
                                        <span>Tanggal Upload : <?php echo $dat['date_post']; ?></span>
                                        <p><?php echo substr($dat['desc_article'], 0, 150) . "..."; ?></p>
                                    </div>

                                    <div class="card-btn">
                                        <ul>
                                            <li><a class="btn-update" style="background-color: var(--primary); color: var(--color-font2)" href="update.php?id=<?php echo $dat['id_articles']; ?>"><i style="color: var(--color-font2);" class="bi bi-pencil"></i> Ubah</a></li>
                                            <li><a class="btn-delete" style="background-color: red; color: var(--color-font2)" href="delete.php?id=<?php echo $dat['id_articles']; ?>"><i style="color: var(--color-font2);" class="bi bi-trash"></i> Hapus</a></li>
                                            <li><a class="btn-view" style="background-color: blue; color: var(--color-font2)" href="view.php?id=<?php echo $dat['id_articles']; ?>"><i style="color: var(--color-font2);" class="bi bi-eye"></i> Lihat Detail</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- Card Content End -->
                        ...
                        ?>
                            <!-- Card Content Start -->
                            <div class="card-article">
                                <h1 style="display: flex; justify-content: center; width: 100%; font-style: italic; font-size: 1.3rem;">Artikel Belum Ditambahkan!</h1>
                            </div>
                            <!-- Card Content End -->
                        <?php
                        }
