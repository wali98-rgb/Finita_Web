    ...
    <div class="page">
        ...
        <aside class="sidebars">
            ...
            <div class="side-btn">
                ...
                <li><a href="home.php"><i class="bi bi-building"></i> DESTINASI</a></li>
                            ...
                            <form action="update-act.php" method="post" enctype="multipart/form-data">
                                <div class="inp-col-1">
                                    <div class="form-inp">
                                        ...
                                        <input class="inp-file" type="file" name="img_article" id="img_article" value="<?php echo $dat['img_article']; ?>" placeholder="Pilih Sampul Artikel" required>
                                        <input type="hidden" name="id_articles" id="id_articles" value="<?php echo $dat['id_articles']; ?>">
                                    </div>

                                    <div class="form-inp">
                                        <p><label for="title_article">Judul Artikel :</label></p>
                                        <input type="text" name="title_article" id="title_article" value="<?php echo $dat['title_article']; ?>" placeholder="Masukkan Judul Artikel" required>
                                    </div>
                                </div>
                                ...
                                <div class="inp-col-2">
                                    <div class="form-inp">
                                        ...
                                        <textarea name="desc_article" id="desc_article" cols="30" rows="10" placeholder="Masukkan Isian Pembahasan Artikel" required><?php echo $dat['desc_article']; ?></textarea>
                                    </div>
                                </div>

                                <div class="inp-sub">
                                    <div class="note">
                                        <p>Form : Pengeditan Artikel</p>
                                    </div>
