...
?>
        ...
        <span>Diposting : <?php echo $row['date_documentation']; ?></span>
        <h3>Dokumentasi <?php echo $row['title_documentation']; ?></h3>
        <p><?php echo ucfirst($row['desc_documentation']); ?></p>
<?php
    }
} else {
    echo "0 hasil";
