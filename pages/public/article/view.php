    ...
    <section class="view">
        ...
        <div class="content">
            ...
            while ($dat = mysqli_fetch_array($data)) {
                $img_article = $dat['img_article'];
                $title_article = $dat['title_article'];
                $date_post = $dat['date_post'];
                $desc_article = $dat['desc_article'];
            ?>
                <div class="content-img">
                    <img src="../../admin/article/file_img/<?php echo $img_article; ?>" alt="Kota <?php echo $title_article; ?>">
                </div>

                <div class="header">
                    <h1><?php echo ucfirst($title_article); ?></h1>
                </div>

                <div class="main">
                    <p class="time">Diposting : <?php echo $date_post; ?></p>
                </div>

                <div class="desc">
                    <p><?php echo $desc_article; ?></p>
                </div>
            <?php
            }
            ?>
